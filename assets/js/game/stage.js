...
export function showStageNotification(stageInfo) {
...
export function applyLoopDifficultyScaling(runtime, qaConfig, loopCount) {
...
export function updateStageProgress(runtime, playerDist, qaConfig) {
...
export function getTargetColor(runtime, targetColorIndex) {
