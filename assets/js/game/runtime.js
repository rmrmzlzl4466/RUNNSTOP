export const STATE = Object.freeze({ RUN: 0, WARNING: 1, STOP: 2, PAUSE: 3 });

export function createRuntimeState(canvas, qaConfig) {
  const runtime = {
    gameState: STATE.RUN,
    gameActive: false,
    cycleTimer: 0,
...
export function syncCanvasSize(runtime, canvas) {
...
export function resetRuntime(runtime, qaConfig) {
